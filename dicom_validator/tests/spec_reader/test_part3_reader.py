...
class TestReadPart3:
    ...
    @pytest.mark.parametrize(
        "edition,iod_name",
        [("2015b", "Computed Tomography Image IOD"), ("2026b", "CT Image IOD")],
        indirect=["edition"],
        scope="session",
    )
    ...
    @pytest.mark.parametrize("edition", ["2015b", "2026b"], indirect=True)
    ...
    @pytest.mark.parametrize(
        "edition", ["2015b", "2026b"], indirect=True, scope="session"
    )
