...
class TestPart6Reader:
    ...
    def test_uid_type(self, reader):
        ...
        assert xfer_syntax_uids['1.2.840.10008.1.2.4.80'] == 'JPEG-LS Lossless Image Compression'
    ...
    def test_sop_class_name(self, reader):
        assert reader.sop_class_name('1.2.840.10008.5.1.4.1.1.6.2') == 'Enhanced US Volume Storage'
