...
def test_valid_editions(base_path, edition_path):
    reader = MemoryEditionReader(
        base_path, '<html><A HREF="/bla/">2014a</A>'
                   '2014b'
                   '<a ref="foo">2015</a>'
                   '<a ref="foo">2017e</a>')
...
def test_update_if_no_local_version_exists(base_path, create_edition_file_over_a_month_old):
    reader = MemoryEditionReader(base_path, '<html><A HREF="/bla/">2018a</A>')
...
def test_is_current(base_path):
    reader = MemoryEditionReader(base_path, '<html>'
                                            '<a ref="foo">2014a</a>'
                                            '<a ref="foo">2014c</a>'
                                            '<a ref="foo">2015a</a>'
                                            '<a ref="foo">2015e</a>')
